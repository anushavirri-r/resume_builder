  ...
  const workExpBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Postion"
          placeholder="Enter Position eg. Frontend developer"
          value={values.title}
          onChange={(event) =>
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Project Name"
          value={values.title}
          placeholder="Enter Name eg. Resume Builder"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Full Name"
          placeholder="Enter full name eg. Anusha"
          value={values.name}
          onChange={(event) =>
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          ...
          placeholder="Enter an achievement eg. Frontend developer"
          value={values.title}
